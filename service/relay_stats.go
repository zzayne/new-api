...
// Pointer fields (AvgDurationMs, P50FirstTokenMs, TPS) are nil when no real
...
type ModelStats struct {
	...
	AvgDurationMs   *float64 `json:"avg_duration_ms,omitempty"`
	// P50FirstTokenMs is the median first-token latency in milliseconds.
	// Only non-nil for models that had streaming requests in the query window.
